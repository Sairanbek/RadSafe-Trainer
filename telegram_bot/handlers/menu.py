...
async def about(message: Message):
    await message.answer(
        ...
        "🔒 Конфиденциальность: бот хранит ваш Telegram ID, результаты тестов и историю "
        "попыток для показа статистики. Сообщения ИИ-ассистенту обрабатываются сервисом "
        "Google Gemini. Чтобы удалить свои данные, напишите разработчику."
    )